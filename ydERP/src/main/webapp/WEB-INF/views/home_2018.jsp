...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/jqgrid5/grid.locale-kr.js" type="text/javascript">
	</script>
	<script src="${pageContext.request.contextPath}/resources/jqgrid5/jquery.jqGrid.min.js" type="text/javascript">
	</script>
	...
	<script type='text/javascript' src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.9.0/fullcalendar.min.js">
	</script>
		...
		function drawBubbleChart() {
			...
			$.ajax({
				...
				success: function (datas) {
					...
					for (i = 0; i < datas.length; i++) {
						bubbleChartData.push([datas[i].itemName, datas[i].itemPrice, datas[i].saleQty,
							datas[i].itemCategory, datas[i].itemQty
						]);
					};
					...
					window.addEventListener(
						'resize',
						function () {
							bubbleChart.draw(google.visualization.arrayToDataTable(bubbleChartData),
								bubbleChartOptions);
						},
						false
					);
	...
	<div class="row">
			...
			<div class="panel panel-primary">
				...
				<a href="getSalesRequesting">
					<div class="panel-footer">
						<span class="pull-left" id="vdetail_1">View Detail</span> <span class="pull-right"><i
		...
		<div class="col-lg-3 col-md-6">
			<div class="panel panel-green">
				...
				<a href="getPurchaseRequesting">
					<div class="panel-footer">
						<span class="pull-left" id="vdetail_2">View Details2</span> <span class="pull-right"><i
								class="fa fa-arrow-circle-right"></i></span>
						<div class="clearfix"></div>
					</div>
				</a>
		...
		<div class="col-lg-3 col-md-6">
			<div class="panel panel-yellow">
				...
				<a href="getPurchaseReceipting">
					<div class="panel-footer">
						<span class="pull-left" id="vdetail_3">View Details3</span> <span class="pull-right"><i
								class="fa fa-arrow-circle-right"></i></span>
						<div class="clearfix"></div>
					</div>
				</a>
		...
		<div class="col-lg-3 col-md-6">
			<div class="panel panel-red">
				...
				<a href="getOrderList">
					<div class="panel-footer">
						<span class="pull-left" id="vdetail_4">View Details4</span> <span class="pull-right"><i
								class="fa fa-arrow-circle-right"></i></span>
						<div class="clearfix"></div>
					</div>
				</a>
